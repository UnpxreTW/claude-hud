...
test('render does not treat a real 40-column terminal as unknown maxWidth fallback', () => {
  ...
  ctx.extraLabel = '12345678901234567890123456789';
  ...
  assert.ok(lines[0].includes('12345678901234567890123456789'), 'full extra label should remain visible at the real terminal width');
